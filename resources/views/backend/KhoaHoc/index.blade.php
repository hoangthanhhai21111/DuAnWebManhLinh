...
<div class="page-inner">
    <header class="page-title-bar">
        ...
        <div class="d-md-flex align-items-md-start">
            <h1 class="page-title mr-sm-auto">Danh Sách Các Lớp Học</h1>
        ...
        <div class="card card-fluid">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <form action="" method="GET" id="form-search">
                                <a href="{{ route('lop-hoc.create') }}" class="btn btn-primary mr-2">
                                    <i class="fa-solid fa fa-plus"></i>
                                    <span class="ml-1">Thêm Mới</span>
                                </a>
                                @include('backend.khoahoc.modal')
                        </form>
                    </div>
                </div>
                        ...
                        <tbody>
                             @foreach ($khoahocs as $key => $khoahoc)
                                <tr>
                                    ...
                                    <td>{{ $khoahoc->Hang->ten_hang}}</td>
                                    <td>{{ $khoahoc->Hang->ten_hang}}</td>
                                    <td>
                                        <form action="{{ route('khoahocs.destoy', $khoahoc->id) }}" method="post">

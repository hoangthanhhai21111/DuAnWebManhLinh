                    ...
                    <div id="row-333920144" class="row large-columns-3 medium-columns- small-columns-1 row-masonry"
                        ...
                        @foreach ($tintucs as $tintuc)
                            <div class="col post-item">
                                <div class="col-inner">
                                    <a href="{{ route('home.show', ['id' => $tintuc->id, 'slug' => str_slug($tintuc->title)]) }}"
                                        class="plain">
                                        <div class="box box-text-bottom box-blog-post has-hover">
                                            ...
                                            <div class="badge absolute top post-date badge-outline">
                                                <div class="badge-inner">
                                                    <span
                                                        class="post-date-day">{{ $tintuc->updated_at->format('d') ?? $tintuc->created_at->format('d') }}</span><br />
                                                    <span
                                                        class="post-date-month is-xsmall">{{ $tintuc->updated_at->format('d') ?? $tintuc->created_at->format('m') }}</span>
                                                    <span
                                                        class="post-date-month is-xsmall">{{ $tintuc->created_at->format('y') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </a>

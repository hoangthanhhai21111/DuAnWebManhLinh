                ...
                <div class="large-9 col">
                    ...
                    <div id="comments" class="comments-area">
                        <div id="respond" class="comment-respond">
                            ...
                            <form action="{{ route('home.regiter') }}" method="post" id="commentform" class="comment-form"
                                novalidate>
                                @csrf
                                ...
                                <p class="comment-form-comment">
                                    ...
                                    <textarea id="comment" name="notepad" cols="45" rows="8" maxlength="65525" required></textarea>
                                </p>
                                <p class="form-submit"><input name="submit" type="submit" id="submit" class="submit"
                                        value="Đăng ký" /> <input type='hidden' name='comment_post_ID' value='694'
                                        id='comment_post_ID' />
                                            ...
                                            <div class="flex-col mr-half">
                                                <div class="badge post-date  badge-outline">
                                                    <div class="badge-inner bg-fill"
                                                        style="background: url({{ asset($top->image) }}); border:0;">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="flex-col flex-grow">
                                                <a href="{{ route('home.show', ['id' => $top->id, 'slug' => str_slug($top->title)]) }}"
                                                    title="Đất Nền Quảng Trị, Bán Gấp Lô Đất Nền tại Đông Hà">{{ $top->title }}</a>

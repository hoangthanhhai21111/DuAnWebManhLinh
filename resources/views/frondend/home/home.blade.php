                                    ...
                                    <div class="row row-small align-middle" id="row-1031561319">
                                        <div id="col-1363285695" class="col medium-6 small-12 large-6"
                                            ...
                                            <div class="col-inner">
                                                ...
                                                <a data-animate="fadeInLeft" href="{{ route('home.gioi_thieu') }}" target="_self"
                                    ...
                                    <div class="row row-small" id="row-1523900692"> @foreach ($thongbaos as $thongbao)
                                        <div id="col-2044222511" class="col medium-4 small-12 large-4"
                                            ...
                                            <div class="col-inner text-center">
                                                ...
                                                <h3>{{ Str::words($thongbao->title,10)}}</h3>
                                                ...
                                                <div id="text-2151010940" class="text">
                                                    <p>{!! Str::words($thongbao->description,30) !!}</p>
                                                ...
                                                <a data-animate="fadeInRight" href="{{ route('home.show',['id' => $thongbao->id,'slug'=>str_slug($thongbao->title)]) }}" target="_self"
                ...
                <div class="row align-equal" id="row-506155279">
                    <div id="col-1327100458" class="col medium-4 small-12 large-4">
                        <div class="col-inner">
                            ...
                            <a href="{{ route('home.su_kien') }}" target="_self" class="button alert is-outline">
                                <span>Xem Thêm</span>
                            ...
                            <div class="row large-columns-2 medium-columns- small-columns-1 has-shadow row-box-shadow-1 slider row-slider slider-nav-circle slider-nav-push"
                                ...
                                @foreach ($tintucs as $tintuc)
                                    <div class="col post-item">
                                        <div class="col-inner">
                                            <a href="{{ route('home.show',['id' => $tintuc->id,'slug'=>str_slug(Str::words($tintuc->title,10))]) }}" class="plain">
